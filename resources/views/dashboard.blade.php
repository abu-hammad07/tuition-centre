                            ...
                            <ul class="hstack mb-0">
                                <li class="ms-n8">
                                    <a href="javascript:void(0)" class="me-1">
                                        <img src="{{ URL::asset('dist/images/profile/user-2.jpg') }}"
                                ...
                                <li class="ms-n8">
                                    <a href="javascript:void(0)" class="me-1">
                                        <img src="{{ URL::asset('dist/images/profile/user-3.jpg') }}"
                                            class="rounded-circle border border-2 border-white" width="44"
                                            height="44" alt="" />
                                    </a>
                                </li>
                                <li class="ms-n8">
                                    <a href="javascript:void(0)" class="me-1">
                                        <img src="{{ URL::asset('dist/images/profile/user-4.jpg') }}"
                                            class="rounded-circle border border-2 border-white" width="44"
                                            height="44" alt="" />
                                    </a>
                                </li>
                                <li class="ms-n8">
                                    <a href="javascript:void(0)" class="me-1">
                                        <img src="{{ URL::asset('dist/images/profile/user-5.jpg') }}"
                                            class="rounded-circle border border-2 border-white" width="44"
                                            height="44" alt="" />
                                    </a>
                                </li>
                ...
                <div class="card bg-primary border-0 w-100">
                    <div class="card-body pb-0">
                        ...
                        <div class="text-center mt-3">
                            <img src="{{ URL::asset('dist/images/backgrounds/piggy.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                    </div>
